...
class Profile extends Component {
    ...
    renderLinks() {
        if (this.props.authenticated) {
            ...
            return [
                <li className='nav-item active' key={2}>
                    <Link className='btn btn-default tg-login__btn' to='/signin'>Sign Ind</Link>
                </li>
                ,
                <li className='nav-item' key={3}>
    ...
    render() {
        ...
        let Email = localStorage.getProfile('userEmail');
        return (
          ...
          <ul className="itineraries">
            ...
            <li key={saved_itins.place_id}>
              ...
              {saved_itins.name} {saved_itins.price_level} {saved_itins.rating} {saved_itins.vicinity} 
                    ...
                    <h4>Welcome to the profile, you have logged in correctly :) </h4>
                    {
                ...
                <div className='col-md-3'>
                    <h2>Andre Mitchell you got this</h2>
...
const mapStatetoProps = (state) => ({
    prifile_retrieved: state.profile_retrieved
});
